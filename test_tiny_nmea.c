...
bool test_tiny_nmea() {
	...
	result &= assertEqualUint32(nmea_haversine(59000000, 24000000, 0, 0), 6886584);
	result &= assertEqualUint32(nmea_haversine(59000000, 24000000, -59000000, -24000000), 13773169);
	result &= assertEqualUint32(nmea_haversine(51510357, -116773, 38889931, -77009003), 5897658);
	result &= assertEqualUint32(nmea_haversine(-54733412, -65938698, 70994326, 28386328), 15770416);
	result &= assertEqualUint32(nmea_haversine(59437424, 24744756, 59437134, 24745496), 52);
